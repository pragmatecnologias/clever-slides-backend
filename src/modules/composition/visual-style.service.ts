  ...
  profileForKey(key: VisualStyleKey, sermon: Sermon, understanding: SermonUnderstanding): VisualStyleProfile {
    ...
    const base = {
      reverent_worship: {
        ...
        typography: { heading: 'Montserrat', body: 'Inter', accent: '#93C5FD' },
      ...
      warm_pastoral: {
        label: 'Warm Pastoral',
        palette: ['#3B82F6', '#F59E0B', '#FDF2E9', '#1F2937'],
        typography: { heading: 'Merriweather', body: 'Inter', accent: '#F97316' },
      ...
      evangelistic_invitation: {
        ...
        palette: ['#111827', '#2563EB', '#F8FAFC', '#FDE68A'],
        typography: { heading: 'Montserrat', body: 'Inter', accent: '#FACC15' },
        backgroundPolicy: 'Use decisive, invitational visuals with clear focal points.',
        imageStyle: 'Bright, invitational, hope-forward, decision-centered.',
        slideDensity: 'medium' as const,
      ...
      hopeful_prophecy: {
        ...
        backgroundPolicy: 'Use light, worship, horizon, and gospel imagery; avoid fear visuals.',
        imageStyle: 'Hopeful, luminous, non-sensational prophetic imagery.',
        slideDensity: 'medium' as const,
      ...
      spanish_church_warm: {
        ...
        typography: { heading: 'Merriweather', body: 'Inter', accent: '#FB923C' },
    ...
    return {
      ...
      slideDensity: profile.slideDensity,
      socialCardStyle: profile.socialCardStyle,
      prophecyRules: profile.prophecyRules,
    };
  }
}
